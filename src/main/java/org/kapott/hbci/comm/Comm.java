...
public abstract class Comm {
    ...
    protected Comm(HBCIPassportInternal parentPassport) {
        ...
        HBCIUtilsInternal.getCallback().callback(parentPassport, HBCICallback.NEED_CONNECTION, HBCIUtilsInternal.getLocMsg("CALLB_NEED_CONN"),
    ...
    public void close() {
        closeConnection();
        HBCIUtilsInternal.getCallback().callback(getParentPassport(), HBCICallback.CLOSE_CONNECTION, HBCIUtilsInternal.getLocMsg("CALLB_CLOSE_CONN"),
                        HBCICallback.TYPE_NONE, new StringBuffer());
    }
}
