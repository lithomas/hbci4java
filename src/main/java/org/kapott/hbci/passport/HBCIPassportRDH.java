...
/**
 * <p>
 * <em><b>Veraltete</b></em> Passport-Klasse für RDH-Zugänge mit Sicherheitsmedium "Datei". Diese Klasse sollte nicht mehr benutzt werden, sondern statt dessen
 * die Klasse {@link org.kapott.hbci.passport.HBCIPassportRDHNew}. RDH-Passport-Datei können mit dem Tool {@link org.kapott.hbci.tools.ConvertRDHPassport} oder
 * mit Hilfe des separat verfügbaren <em>HBCI4Java Passport Editors</em> in RDHNew-Passport-Dateien umgewandelt werden. Siehe dazu auch die Daten
