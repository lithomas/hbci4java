...
/**
 * <p>
 * Passport-Klasse für die Verwendung von SIZ-RDH-Schlüsseldateien mit <em>HBCI4Java</em>. SIZ-RDH-Schlüsseldateien sind Schlüsseldateien für RDH-Zugänge, die
 * von anderer HBCI-Software erzeugt und verwendet werden (z.B. von <em>StarMoney</em>). Soll eine solche Schlüsseldatei sowohl mit der anderen Software als
 * auch mit <em>HBCI4Java</em> verwendet werden, so kann das mit dieser Passport-Variante geschehen. Soll die Schlüsseldatei nur noch mit <em>HBCI4Java</em>
 * benutzt werden, so ist eine Konvertierung der Schlüsseldatei in ein anderes Passport-Format (vorzugsweise <code>RDHNew</code>) zu empfehlen. Dazu kann der
 * <em>HBCI4Java Passport Editor</em> oder das Tool {@link org.kapott.hbci.tools.ConvertSIZRDHPassport} verwendet werden.
 * </p>
 * <p>
 * <b>Achtung: In der reinen GPL-Version von <em>HBCI4Java</em> ist diese Klasse nicht funktionstüchtig.</b> Der Grund dafür ist, dass <code>SIZRDHFile</code>
 * eine zusätzliche Bibliothek zur Laufzeit benötigt. Diese Bibliothek steht nur als Binary-Version unter <a
 * href="http://hbci4java.kapott.org#download">http://hbci4java.kapott.org</a> zur Verfügung. Erst nach Installation dieser Bibliothek können
 * SIZRDHFile-Passports benutzt werden.
 * </p>
 * <p>
 * <b>Siehe auch die Datei <code>README.SIZRDHFile</code>.</b>
 * </p>
 */
public class HBCIPassportSIZRDHFile extends AbstractRDHSWFileBasedPassport {
        ...
        if (init) {
            ...
            try {
                if (passphrase == null) {
                    ...
                    HBCIUtilsInternal.getCallback().callback(this, HBCICallback.NEED_PASSPHRASE_LOAD, HBCIUtilsInternal.getLocMsg("CALLB_NEED_PASS"),
    ...
    public int askForEntryIdx(String possibilities) {
        ...
        HBCIUtilsInternal.getCallback()
                        .callback(this, HBCICallback.NEED_SIZENTRY_SELECT, "*** select one of the following entries", HBCICallback.TYPE_TEXT, sb);
