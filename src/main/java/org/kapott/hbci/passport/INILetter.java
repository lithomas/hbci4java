...
/**
 * Hilfsklasse für das Erzeugen von INI-Briefen (für RDH-Zugänge). Diese Klasse ermöglicht das Erzeugen von INI-Briefen. Dazu werden Methoden bereitgestellt,
 * mit deren Hilfe die für einen INI-Brief benötigten Daten ermittelt werden können. Außerdem liefert die {@link #toString()}-Methode einen vorgefertigten
...
public class INILetter {
     ...
     * 
     * @param passport
     *            das Passport-Objekt (entspricht einem HBCI-Zugang), für den ein INI-Brief benötigt wird
     * @param type
     *            gibt an, für welche Schlüssel aus dem <code>passport</code> der INI-Brief benötigt wird ({@link #TYPE_INST} für die Bankschlüssel,
