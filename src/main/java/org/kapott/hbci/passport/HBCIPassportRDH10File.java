...
/**
 * Compatibility and convenience class for applications using the "RDH2File" passport variant. To avoid user confusion (using RDH-10-keys with passport variant
 * "RDH2File") this class is a kind of alias for RDH2File (with exact the same behaviour). Both RDH2File and RDH10File are deprecated now - use the more general
 * name RDHXFile instead.
 * 
