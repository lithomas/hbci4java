...
/**
 * Ergebnisdaten für die Abfrage einer Depotaufstellung. Diese Klasse enthält für jedes Depot ein separates Datenobjekt. Innerhalb eines Depots werden für jede
 * in diesem Depot vorhandene Wertpapiergattung separate Datenobjekte gehalten. Für jede Wertpapiergattung wiederum gibt es u.U. mehrere Objekte, die
 * Saldeninformationen enthalten.
 */
public final class GVRWPDepotList extends HBCIJobResultImpl {
    ...
    public static final class Entry {
        ...
        public static final class Gattung {
            ...
            public static final class SubSaldo {
                ...
                /**
                 * Gibt an, ob das Papier für einen Verkauf zur Verfügung steht. <code>true</code> gibt an, dass das Papier gesperrt ist und somit nicht zur
                 * Verfügung steht, bei <code>false</code> kann es verkauft werden
                 */
                public boolean locked;
                /**
                 * Saldobetrag. Das Währungsfeld <code>curr</code> ist hier zur Zeit immer der leere String.
                 */
                public BigDecimalValue saldo;
                /**
                 * Lagerland der Depotstelle (optional). Der Ländercode ist der ISO-3166-Ländercode (z.B. DE für Deutschland)
                 */
            ...
            /**
             * Preis pro Einheit (optional). Die Währung ist bei {@link #pricetype}={@link #PRICE_TYPE_PRCT} auf "%" gesetzt.
             */
            ...
            public int source;
            /**
             * Bemerkungen zur Herkunft von Preis/Kurs {@link #source} (optional). Bei {@link #source}={@link #SOURCE_LOC} kann der Name der Börse als MIC
             * angegeben werden
             */
            ...
            /**
             * Gibt alle Unter-Saldoinformationen in einem Array zurück. Der Rückgabewert ist niemals <code>null</code>, das Array kann aber die Länge
             * <code>0</code> haben.
             * 
            ...
            public String toString() {
                ...
                if (zinssatz != 0)
                    ret.append("Zinssatz: ").append(HBCIUtilsInternal.bigDecimal2String(new BigDecimal(zinssatz).divide(new BigDecimal("1000.0"))))
                                    .append(linesep);
        ...
        /**
         * Gibt ein Array mit Informationen über alle Wertpapiergattungen zurück, die in diesem Depot gehalten werden. Der Rückgabewert ist niemals
         * <code>null</code>, die Größe des Arrays kann aber 0 sein.
         * 
    ...
    /**
     * Dieses Feld enthält einen String, der den nicht-auswertbaren Teil der gelieferten Informationen enthält. Es dient nur zu Debugging-Zwecken und sollte
     * eigentlich immer <code>null</code> bzw. einen leeren String enthalten. Wenn das nicht der Fall ist, dann konnten die empfangenen Daten nicht richtig
     * geparst werden, und dieser String enthält den "Schwanz" der Daten, bei dem das Parsing-Problem aufgetreten ist.
     */
    public String rest;
