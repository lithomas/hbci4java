...
public class HBCIJobResultImpl implements Serializable, HBCIJobResult {
    ...
    public boolean isOK() {
        /*
         * return jobStatus.getStatusCode()==HBCIStatus.STATUS_OK || (jobStatus.getStatusCode()==HBCIStatus.STATUS_UNKNOWN &&
        ...
        return globStatus.getStatusCode() != HBCIStatus.STATUS_ERR && jobStatus.getStatusCode() != HBCIStatus.STATUS_ERR
                        && (globStatus.getStatusCode() != HBCIStatus.STATUS_UNKNOWN || jobStatus.getStatusCode() != HBCIStatus.STATUS_UNKNOWN);
    }
