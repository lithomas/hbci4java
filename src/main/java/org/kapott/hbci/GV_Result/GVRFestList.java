...
/**
 * Ergebnisse der Abfrage bestehender Festgeldanlange. Die verschiedenen Festgeldanlagen werden in einer Liste gespeichert. Für jede bestehende Festgeldanlage
 * gibt es ein separates Objekt mit Informationen über diese Anlage.
 */
public final class GVRFestList extends HBCIJobResultImpl {
    /** Informationen über eine einzelne. Festgeldanlage */
    public static final class Entry {
        /**
         * Informationen darüber, wie eine Festgeldanlage bei Ablauf der Laufzeit zu verlängern ist
         */
        public static final class Prolong {
            ...
            public Value betrag;
            /**
             * Soll Festgeldanlage nach der zusätzlichen <code>laufzeit</code> erneut verlängert werden?
             */
        ...
        /**
         * Soll die Festgeldanlage nach Ablauf des Anlagezeitraumes verlängert werden? Wenn ja, dann enthält das Feld <code>verlaengerung</code> entsprechende
