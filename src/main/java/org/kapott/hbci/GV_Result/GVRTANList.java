...
/**
 * Diese Klasse enthält Informationen über aktuelle TAN-Listen des Kunden. Dabei wird für jede TAN-Liste ein separates Objekt erzeugt. Innerhalb einer
 * TAN-Listen-Informationen gibt es zu jeder verbrauchten TAN genauere Daten.
 */
public class GVRTANList extends HBCIJobResultImpl {
    ...
    public static class TANInfo {
        ...
        public static final String[] usageCodes = { "TAN ist frei", "(not used)", "PIN-Änderung", "Kontosperre aufheben", "Aktivieren neuer TAN-Liste",
                        "Entwertete TAN (maschinell)", "Mitteilung mit TAN", "Überweisung", "Wertpapierorder", "Dauerauftrag",
                        "Entwertet wegen Zeitüberschreitung im Zweischritt-Verfahren",
                        "Entwertet wegen Zeitüberschreitung im Zweischritt-Verfahren (Mehrfach-Signaturen)", "Entwertet (falsche Antwort auf Challenge?)", "",
                        "", "", "", "", "", "", "Lastschriften", "Euro-Überweisung", "Auslandsüberweisung", "Terminüberweisung", "Umbuchung" };
        ...
        /**
         * Erläuterung für TAN-Verwendung. Wenn {@link #usagecode}==<code>99</code> ist, dann enthält dieser String optional einen erläuternden Text, wofür die
         * TAN verbraucht wurde.
         */
        public String usagetxt;

        /**
         * Die TAN selbst. Ist nur dann gesetzt, wenn die TAN tatsächlich bereits verbraucht wurde, sonst ist dieses Feld <code>null</code>
         */
        public String tan;

        /**
         * Zeitpunkt, wann die TAN verbraucht wurde. Diese Variable ist nur dann ungleich <code>null</code>, wenn die TAN tatsächlich bereits verbraucht wurde
         */
