...
public final class SyntaxDate extends SyntaxDE {
     ...
     * @param x
     *            date in format d.m.y (with no restrictions concerning the number of digits for each field)
     ...
     * @param x
     *            a date in hbci-format (i.e. yyyymmdd)
     * @return this date in human-readable-format dd.mm.yyyy with this number of digits (i.e. using leading zeroes)
     */
