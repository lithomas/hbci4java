...
public class SyntaxAN extends SyntaxDE {
     ...
     * 
     *        This constructor creates a new data element from a given HBCI message. For this the first token in the HBCI message will be extracted from @p res
     *        and used as init value for the data element
     * @param res
     *            A part of the HBCI-message to be parsed. From this (sub-)string the first token will be used to initialize the data element.
     * @param minsize
     *            The minimum string length for this element.
     * @param maxsize
