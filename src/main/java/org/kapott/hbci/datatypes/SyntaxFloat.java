...
public class SyntaxFloat extends SyntaxDE {
     ...
     * @param st
     *            a double number in string format (with "," or "." as decimal delimiter)
     * @return a valid hbci-representation of this number (i.e. with "," as decimal delimiter and with no trailing zeroes after the "0")
     */
