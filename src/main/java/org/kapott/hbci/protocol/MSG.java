...
public final class MSG extends SyntaxElement {
    ...
    /**
     * in 'clientValues' wird eine hashtable uebergeben, die als schluessel den pfadnames und als wert den wert eines zu setzenden elementes enthaelt. mit der
     * methode werden vom nutzer einzugebenede daten (wie kontonummern, namen usw.) in die generierte nachricht eingebaut
     */
    ...
    public MSG(String type, String res, int fullResLen, MsgGen gen, boolean checkSeq, boolean checkValids) {
        super(type, type, null, (char) 0, 0, new StringBuffer(res), fullResLen, gen.getSyntax(), new Hashtable<String, String>(),
    ...
    public void init(String type, String res, int fullResLen, MsgGen gen, boolean checkSeq, boolean checkValids) {
        super.init(type, type, null, (char) 0, 0, new StringBuffer(res), fullResLen, gen.getSyntax(), new Hashtable<String, String>(),
                        checkValids ? new Hashtable<String, String>() : null);
        initData(type, res, fullResLen, gen, checkSeq, checkValids);
    }
