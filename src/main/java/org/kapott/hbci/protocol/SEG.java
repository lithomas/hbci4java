...
public final class SEG extends SyntaxElement {
    ...
    public void setSeq(int idx, boolean allowOverwrite) {
        ...
        if (!propagateValue(targetPath, Integer.toString(idx), DONT_TRY_TO_CREATE, allowOverwrite))
    ...
    protected MultipleSyntaxElements parseNewChildContainer(Node dataref, char predelim0, char predelim1, StringBuffer res, int fullResLen, Document syntax,
    ...
    public SEG(String type, String name, String path, char predelim, int idx, StringBuffer res, int fullResLen, Document syntax,
                    Hashtable<String, String> predefs, Hashtable<String, String> valids) {
    ...
    public int checkSegSeq(int value) {
        ...
        if (num != value) {
            if (!HBCIUtilsInternal.ignoreError(null, "client.errors.ignoreSegSeqErrors",
                            HBCIUtilsInternal.getLocMsg("EXCMSG_INVSEQNUM", new Object[] { getPath(), new Integer(value), new Integer(num) })))
