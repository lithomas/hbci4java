...
/**
 * Diese Klasse dient als Basisklasse für allen Callback-Klassen. Eine Anwendung sollte zur Erstellung einer eigenen Callback-Klasse diese oder eine der schon
 * bereitgestellten "fertigen" Klassen ({@link org.kapott.hbci.callback.HBCICallbackConsole}, {@link org.kapott.hbci.callback.HBCICallbackSwing}) erweitern
 */
public abstract class AbstractHBCICallback implements HBCICallback {
    /**
     * Erzeugt einen Log-Eintrag. Diese Methode wird von den mitgelieferten Callback-Klassen für die Erzeugung von Log-Einträgen verwendet. Um ein eigenes
     * Format für die Log-Eintrage zu definieren, kann diese Methode mit einer eigenen Implementierung überschrieben werden.<br/>
     * Die Parameter entsprechen denen der {@link HBCICallback#log(String, int, Date, StackTraceElement) log}-Methode
     * 
    ...
    /**
     * Standard-Verhalten - gibt für alle Callbacks <code>false</code> (= asynchrone Callback-Behandlung) zurück.
     */
