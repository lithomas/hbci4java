...
/**
 * Default-Implementation einer Callback-Klasse für Anwendungen mit GUI. Diese Klasse überschreibt die <code>callback()</code>-Methode. Benötigte Nutzereingaben
 * werden hier nicht mehr über STDIN abgefragt, sondern es wird ein neues Top-Level-Window erzeugt, welches die entsprechende Meldung sowie ein Feld zur Eingabe
 * der Antwort enthält. Kernel-Meldungen und erwartete Nutzeraktionen werden ebenfalls durch ein neues Top-Level-Window realisiert. Die Methoden
 * <code>log()</code> und <code>status()</code> werden nicht überschrieben, so dass diese weiterhin das Verhalten der
 * {@link org.kapott.hbci.callback.HBCICallbackConsole}-Klasse zeigen.
 */
