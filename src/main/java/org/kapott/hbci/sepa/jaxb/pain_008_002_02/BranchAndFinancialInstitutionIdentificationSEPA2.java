...
@XmlType(name = "BranchAndFinancialInstitutionIdentificationSEPA2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", propOrder = { "finInstnId" })
public class BranchAndFinancialInstitutionIdentificationSEPA2 {

    @XmlElement(name = "FinInstnId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
