...
@XmlType(name = "pain.008.001.01", namespace = "urn:swift:xsd:$pain.008.002.01", propOrder = { "grpHdr", "pmtInf" })
public class Pain00800101 {
     ...
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the pmtInf property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link PaymentInstructionInformationSDD }
     * 
     * 
     */
