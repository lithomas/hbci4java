...
@XmlType(name = "PaymentInstructionInformationSCT", namespace = "urn:swift:xsd:$pain.001.002.02", propOrder = { "pmtInfId", "pmtMtd", "pmtTpInf",
                "reqdExctnDt", "dbtr", "dbtrAcct", "dbtrAgt", "ultmtDbtr", "chrgBr", "cdtTrfTxInf" })
public class PaymentInstructionInformationSCT {
     ...
     * 
     * @return possible object is {@link CashAccountSCT1 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link CashAccountSCT1 }
     * 
     */
     ...
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the cdtTrfTxInf property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link CreditTransferTransactionInformationSCT }
     * 
     * 
     */
