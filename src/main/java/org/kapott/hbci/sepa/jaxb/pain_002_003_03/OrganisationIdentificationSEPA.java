...
/**
 * <p>
 * Java class for OrganisationIdentificationSEPA complex type.
 * 
 * <p>
...
@XmlType(name = "OrganisationIdentificationSEPA", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03", propOrder = { "bicOrBEI" })
public class OrganisationIdentificationSEPA {

    @XmlElement(name = "BICOrBEI", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03", required = true)
