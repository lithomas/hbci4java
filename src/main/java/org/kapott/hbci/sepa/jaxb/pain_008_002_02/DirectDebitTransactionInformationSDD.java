...
@XmlType(name = "DirectDebitTransactionInformationSDD", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", propOrder = { "pmtId", "instdAmt",
                "chrgBr", "drctDbtTx", "ultmtCdtr", "dbtrAgt", "dbtr", "dbtrAcct", "ultmtDbtr", "purp", "rmtInf" })
public class DirectDebitTransactionInformationSDD {

    @XmlElement(name = "PmtId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    protected PaymentIdentificationSEPA pmtId;
    @XmlElement(name = "InstdAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    ...
    @XmlElement(name = "DrctDbtTx", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    ...
    @XmlElement(name = "DbtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    protected BranchAndFinancialInstitutionIdentificationSEPA1 dbtrAgt;
    @XmlElement(name = "Dbtr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    protected PartyIdentificationSEPA2 dbtr;
    @XmlElement(name = "DbtrAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    protected CashAccountSEPA2 dbtrAcct;
    @XmlElement(name = "UltmtDbtr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02")
    protected PartyIdentificationSEPA1 ultmtDbtr;
    @XmlElement(name = "Purp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02")
    protected PurposeSEPA purp;
    @XmlElement(name = "RmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02")
    protected RemittanceInformationSEPA1Choice rmtInf;

    /**
     * Gets the value of the pmtId property.
     * 
     * @return possible object is {@link PaymentIdentificationSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link PaymentIdentificationSEPA }
     * 
     */
     ...
     * 
     * @return possible object is {@link ActiveOrHistoricCurrencyAndAmountSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link ActiveOrHistoricCurrencyAndAmountSEPA }
     * 
     */
     ...
     * 
     * @return possible object is {@link DirectDebitTransactionSDD }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link DirectDebitTransactionSDD }
     * 
     */
     ...
     * 
     * @return possible object is {@link BranchAndFinancialInstitutionIdentificationSEPA1 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link BranchAndFinancialInstitutionIdentificationSEPA1 }
     * 
     */
     ...
     * 
     * @return possible object is {@link CashAccountSEPA2 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link CashAccountSEPA2 }
     * 
     */
     ...
     * 
     * @return possible object is {@link PurposeSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link PurposeSEPA }
     * 
     */
     ...
     * 
     * @return possible object is {@link RemittanceInformationSEPA1Choice }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link RemittanceInformationSEPA1Choice }
     * 
     */
