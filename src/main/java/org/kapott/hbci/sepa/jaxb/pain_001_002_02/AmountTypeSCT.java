...
@XmlType(name = "AmountTypeSCT", namespace = "urn:swift:xsd:$pain.001.002.02", propOrder = { "instdAmt" })
public class AmountTypeSCT {
     ...
     * 
     * @return possible object is {@link CurrencyAndAmountSCT }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link CurrencyAndAmountSCT }
     * 
     */
