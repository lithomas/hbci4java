...
@XmlType(name = "RemittanceInformation3", namespace = "urn:sepade:xsd:pain.008.001.01", propOrder = { "ustrd", "strd" })
public class RemittanceInformation3 {
     ...
     * 
     * @return possible object is {@link StructuredRemittanceInformation6 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link StructuredRemittanceInformation6 }
     * 
     */
