...
@XmlType(name = "PersonIdentificationSDD1", namespace = "urn:swift:xsd:$pain.008.002.01", propOrder = { "drvrsLicNb", "cstmrNb", "sclSctyNb", "alnRegnNb",
                "psptNb", "taxIdNb", "idntyCardNb", "mplyrIdNb", "dtAndPlcOfBirth", "othrId", "issr" })
public class PersonIdentificationSDD1 {

    @XmlElement(name = "DrvrsLicNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String drvrsLicNb;
    @XmlElement(name = "CstmrNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String cstmrNb;
    @XmlElement(name = "SclSctyNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String sclSctyNb;
    @XmlElement(name = "AlnRegnNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String alnRegnNb;
    @XmlElement(name = "PsptNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String psptNb;
    @XmlElement(name = "TaxIdNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String taxIdNb;
    @XmlElement(name = "IdntyCardNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String idntyCardNb;
    @XmlElement(name = "MplyrIdNb", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected String mplyrIdNb;
    @XmlElement(name = "DtAndPlcOfBirth", namespace = "urn:swift:xsd:$pain.008.002.01")
    protected DateAndPlaceOfBirth dtAndPlcOfBirth;
    @XmlElement(name = "OthrId", namespace = "urn:swift:xsd:$pain.008.002.01")
     ...
     * 
     * @return possible object is {@link GenericIdentification4 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link GenericIdentification4 }
     * 
     */
