...
@XmlType(name = "CreditorReferenceInformationSEPA1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", propOrder = { "tp", "ref" })
public class CreditorReferenceInformationSEPA1 {

    @XmlElement(name = "Tp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
    protected CreditorReferenceTypeSEPA tp;
    @XmlElement(name = "Ref", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
