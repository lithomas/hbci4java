...
@XmlType(name = "PartyIdentificationSEPA2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03", propOrder = { "nm", "pstlAdr", "id" })
public class PartyIdentificationSEPA2 {

    @XmlElement(name = "Nm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03", required = true)
    protected String nm;
    @XmlElement(name = "PstlAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03")
    protected PostalAddressSEPA pstlAdr;
    @XmlElement(name = "Id", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03")
