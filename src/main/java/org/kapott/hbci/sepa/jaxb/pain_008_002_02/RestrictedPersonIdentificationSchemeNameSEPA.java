...
@XmlType(name = "RestrictedPersonIdentificationSchemeNameSEPA", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", propOrder = { "prtry" })
public class RestrictedPersonIdentificationSchemeNameSEPA {
     ...
     * 
     * @return possible object is {@link IdentificationSchemeNameSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link IdentificationSchemeNameSEPA }
     * 
     */
