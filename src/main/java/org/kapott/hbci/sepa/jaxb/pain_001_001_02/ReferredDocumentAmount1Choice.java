...
@XmlType(name = "ReferredDocumentAmount1Choice", namespace = "urn:sepade:xsd:pain.001.001.02", propOrder = { "duePyblAmt", "dscntApldAmt", "rmtdAmt",
                "cdtNoteAmt", "taxAmt" })
public class ReferredDocumentAmount1Choice {

    @XmlElement(name = "DuePyblAmt", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected CurrencyAndAmount duePyblAmt;
    @XmlElement(name = "DscntApldAmt", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected CurrencyAndAmount dscntApldAmt;
    @XmlElement(name = "RmtdAmt", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected CurrencyAndAmount rmtdAmt;
    @XmlElement(name = "CdtNoteAmt", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected CurrencyAndAmount cdtNoteAmt;
    @XmlElement(name = "TaxAmt", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected CurrencyAndAmount taxAmt;

    /**
     * Gets the value of the duePyblAmt property.
     * 
     * @return possible object is {@link CurrencyAndAmount }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link CurrencyAndAmount }
     * 
     */
