...
@XmlType(name = "AccountIdentificationSEPA", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", propOrder = { "iban" })
public class AccountIdentificationSEPA {

    @XmlElement(name = "IBAN", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", required = true)
