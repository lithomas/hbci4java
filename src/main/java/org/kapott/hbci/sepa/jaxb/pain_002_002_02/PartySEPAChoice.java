...
@XmlType(name = "PartySEPAChoice", namespace = "urn:swift:xsd:$pain.002.002.02", propOrder = { "orgId", "prvtId" })
public class PartySEPAChoice {
     ...
     * 
     * @return possible object is {@link PersonIdentification3 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link PersonIdentification3 }
     * 
     */
