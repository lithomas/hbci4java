...
@XmlType(name = "PersonIdentificationSEPA1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03", propOrder = { "dtAndPlcOfBirth", "othr" })
public class PersonIdentificationSEPA1Choice {

    @XmlElement(name = "DtAndPlcOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03")
     ...
     * 
     * @return possible object is {@link GenericPersonIdentification1 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link GenericPersonIdentification1 }
     * 
     */
