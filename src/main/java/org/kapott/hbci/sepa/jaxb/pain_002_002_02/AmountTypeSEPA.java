...
@XmlType(name = "AmountTypeSEPA", namespace = "urn:swift:xsd:$pain.002.002.02", propOrder = { "instdAmt" })
public class AmountTypeSEPA {
     ...
     * 
     * @return possible object is {@link CurrencyAndAmountSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link CurrencyAndAmountSEPA }
     * 
     */
