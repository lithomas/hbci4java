...
@XmlType(name = "OriginalPaymentInformationSEPA", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03", propOrder = { "orgnlPmtInfId", "orgnlNbOfTxs",
                "orgnlCtrlSum", "pmtInfSts", "stsRsnInf", "txInfAndSts" })
public class OriginalPaymentInformationSEPA {
     ...
     * 
     * @return possible object is {@link TransactionGroupStatusCodeSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link TransactionGroupStatusCodeSEPA }
     * 
     */
     ...
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the stsRsnInf property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link StatusReasonInformationSEPA }
     * 
     * 
     */
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the txInfAndSts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link PaymentTransactionInformationSEPA }
     * 
     * 
     */
