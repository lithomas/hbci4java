...
@XmlType(name = "OrganisationIdentificationSCTChoice", namespace = "urn:swift:xsd:$pain.001.002.02", propOrder = { "bic", "ibei", "bei", "eangln", "uschu",
                "duns", "bkPtyId", "taxIdNb", "prtryId" })
public class OrganisationIdentificationSCTChoice {

    @XmlElement(name = "BIC", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String bic;
    @XmlElement(name = "IBEI", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String ibei;
    @XmlElement(name = "BEI", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String bei;
    @XmlElement(name = "EANGLN", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String eangln;
    @XmlElement(name = "USCHU", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String uschu;
    @XmlElement(name = "DUNS", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String duns;
    @XmlElement(name = "BkPtyId", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String bkPtyId;
    @XmlElement(name = "TaxIdNb", namespace = "urn:swift:xsd:$pain.001.002.02")
    protected String taxIdNb;
    @XmlElement(name = "PrtryId", namespace = "urn:swift:xsd:$pain.001.002.02")
     ...
     * 
     * @param value
     *            allowed object is {@link GenericIdentification3 }
     * 
     */
