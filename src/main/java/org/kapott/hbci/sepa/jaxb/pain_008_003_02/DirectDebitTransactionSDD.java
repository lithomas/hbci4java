...
@XmlType(name = "DirectDebitTransactionSDD", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.003.02", propOrder = { "mndtRltdInf", "cdtrSchmeId" })
public class DirectDebitTransactionSDD {

    @XmlElement(name = "MndtRltdInf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.003.02", required = true)
     ...
     * 
     * @return possible object is {@link MandateRelatedInformationSDD }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link MandateRelatedInformationSDD }
     * 
     */
