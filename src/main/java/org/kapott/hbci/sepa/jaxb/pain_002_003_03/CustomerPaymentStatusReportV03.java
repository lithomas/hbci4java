...
@XmlType(name = "CustomerPaymentStatusReportV03", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03", propOrder = { "grpHdr", "orgnlGrpInfAndSts",
                "orgnlPmtInfAndSts" })
public class CustomerPaymentStatusReportV03 {
     ...
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the orgnlPmtInfAndSts property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link OriginalPaymentInformationSEPA }
     * 
     * 
     */
