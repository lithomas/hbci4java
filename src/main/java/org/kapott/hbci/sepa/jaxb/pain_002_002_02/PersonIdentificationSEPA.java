...
@XmlType(name = "PersonIdentificationSEPA", namespace = "urn:swift:xsd:$pain.002.002.02", propOrder = { "othrId" })
public class PersonIdentificationSEPA {
     ...
     * 
     * @return possible object is {@link GenericIdentificationSEPA }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link GenericIdentificationSEPA }
     * 
     */
