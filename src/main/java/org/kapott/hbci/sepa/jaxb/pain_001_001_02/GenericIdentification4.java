...
@XmlType(name = "GenericIdentification4", namespace = "urn:sepade:xsd:pain.001.001.02", propOrder = { "id", "idTp" })
public class GenericIdentification4 {

    @XmlElement(name = "Id", namespace = "urn:sepade:xsd:pain.001.001.02", required = true)
    protected String id;
    @XmlElement(name = "IdTp", namespace = "urn:sepade:xsd:pain.001.001.02", required = true)
