...
@XmlType(name = "PersonIdentification3", namespace = "urn:sepade:xsd:pain.001.001.02", propOrder = { "drvrsLicNb", "cstmrNb", "sclSctyNb", "alnRegnNb",
                "psptNb", "taxIdNb", "idntyCardNb", "mplyrIdNb", "dtAndPlcOfBirth", "othrId", "issr" })
public class PersonIdentification3 {

    @XmlElement(name = "DrvrsLicNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String drvrsLicNb;
    @XmlElement(name = "CstmrNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String cstmrNb;
    @XmlElement(name = "SclSctyNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String sclSctyNb;
    @XmlElement(name = "AlnRegnNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String alnRegnNb;
    @XmlElement(name = "PsptNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String psptNb;
    @XmlElement(name = "TaxIdNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String taxIdNb;
    @XmlElement(name = "IdntyCardNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String idntyCardNb;
    @XmlElement(name = "MplyrIdNb", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected String mplyrIdNb;
    @XmlElement(name = "DtAndPlcOfBirth", namespace = "urn:sepade:xsd:pain.001.001.02")
    protected DateAndPlaceOfBirth dtAndPlcOfBirth;
    @XmlElement(name = "OthrId", namespace = "urn:sepade:xsd:pain.001.001.02")
