...
@XmlType(name = "PersonIdentification4", namespace = "urn:sepade:xsd:pain.008.001.01", propOrder = { "othrId" })
public class PersonIdentification4 {
     ...
     * 
     * @return possible object is {@link RestrictedIdentification2 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link RestrictedIdentification2 }
     * 
     */
