...
@XmlType(name = "FinancialInstitutionIdentification5", namespace = "urn:sepade:xsd:pain.008.001.01", propOrder = { "prtryId" })
public class FinancialInstitutionIdentification5 {
     ...
     * 
     * @return possible object is {@link RestrictedIdentification1 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link RestrictedIdentification1 }
     * 
     */
