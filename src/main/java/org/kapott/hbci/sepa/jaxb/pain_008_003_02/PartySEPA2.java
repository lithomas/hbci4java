...
@XmlType(name = "PartySEPA2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.003.02", propOrder = { "prvtId" })
public class PartySEPA2 {

    @XmlElement(name = "PrvtId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.003.02", required = true)
