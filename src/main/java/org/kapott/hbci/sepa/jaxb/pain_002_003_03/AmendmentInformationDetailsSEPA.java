...
@XmlType(name = "AmendmentInformationDetailsSEPA", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03", propOrder = { "orgnlMndtId",
                "orgnlCdtrSchmeId", "orgnlDbtrAcct", "orgnlDbtrAgt" })
public class AmendmentInformationDetailsSEPA {

    @XmlElement(name = "OrgnlMndtId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03")
    protected String orgnlMndtId;
    @XmlElement(name = "OrgnlCdtrSchmeId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03")
    protected PartyIdentificationSEPA4 orgnlCdtrSchmeId;
    @XmlElement(name = "OrgnlDbtrAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03")
    protected CashAccountSEPA2 orgnlDbtrAcct;
    @XmlElement(name = "OrgnlDbtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03")
     ...
     * 
     * @return possible object is {@link BranchAndFinancialInstitutionIdentificationSEPA2 }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link BranchAndFinancialInstitutionIdentificationSEPA2 }
     * 
     */
