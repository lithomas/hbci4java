...
public class DDVCardService1 extends DDVCardService {
    ...
    public void init(Card card) {
        ...
        CommandAPDU command = new CommandAPDU((byte) 0x00, (byte) 0xa4, (byte) 0x04, (byte) 0x0c, new byte[] { (byte) 0xd2, (byte) 0x76, (byte) 0x00,
                        (byte) 0x00, (byte) 0x25, (byte) 0x48, (byte) 0x42, (byte) 0x02, (byte) 0x00 });
        send(command);
    }
    ...
    protected byte[] calculateSignature(byte[] data_l) {
        byte[] body = new byte[] { SECCOS_SM_RESP_DESCR, (byte) 0x0c, SECCOS_SM_CRT_CC, (byte) 0x0a, SECCOS_SM_REF_INIT_DATA, (byte) 0x08, data_l[0],
                        data_l[1], data_l[2], data_l[3], data_l[4], data_l[5], data_l[6], data_l[7], SECCOS_SM_VALUE_LE, (byte) 0x01, (byte) 0x00 };

        CommandAPDU command = new CommandAPDU(SECCOS_CLA_SM1, SECCOS_INS_READ_RECORD, (byte) 0x01, (byte) ((0x1B << 3) | 0x04), body, 256);
