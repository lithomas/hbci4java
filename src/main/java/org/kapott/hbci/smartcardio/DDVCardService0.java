...
public class DDVCardService0 extends DDVCardService {
    ...
    public void init(Card card) {
        ...
        CommandAPDU command = new CommandAPDU((byte) 0x00, (byte) 0xa4, (byte) 0x04, (byte) 0x0c, new byte[] { (byte) 0xd2, (byte) 0x76, (byte) 0x00,
                        (byte) 0x00, (byte) 0x25, (byte) 0x48, (byte) 0x42, (byte) 0x01, (byte) 0x00 });
        send(command);
    }
    ...
    protected byte[] calculateSignature(byte[] data_l) {
        ...
        CommandAPDU command = new CommandAPDU(SECCOS_CLA_SM_PROPR, SECCOS_INS_READ_RECORD, (byte) 0x01, (byte) ((0x1B << 3) | 0x04), 256);
