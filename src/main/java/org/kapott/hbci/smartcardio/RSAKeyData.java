...
public class RSAKeyData {
    ...
    public enum Type {
        ...
        ENCIPHER(0), SIGN(1), DECIPHER(2), VERIFY(3);
    ...
    public String toString() {
        return "index=" + index + " type=" + type + " keyType=0x" + Integer.toHexString(keyType) + " status=0x" + Integer.toHexString(status) + " keyNum="
                        + keyNum + " keyVersion=" + keyVersion + " publicKey=" + publicKey;
    }
