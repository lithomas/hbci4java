 ...
 * 
 * WICHTIG: Diese Klasse sowie die Ableitungen sollten auch ohne initialisiertes HBCI-System funktionieren, um das XML ohne HBCI-Handler erstellen zu koennen.
 * Daher sollte auf die Verwendung von "HBCIUtils" & Co verzichtet werden. Das ist auch der Grund, warum hier das Java-Logging verwendet wird und nicht das
 * HBCI4Java-eigene.
 */
public abstract class AbstractSEPAGenerator implements ISEPAGenerator {
     ...
     * 
     * @param e
     *            das zu schreibende JAXBElement mit der Bean.
     * @param type
     *            der Typ der Bean.
     * @param os
     *            der OutputStream, in den das XML geschrieben wird.
     * @param validate
