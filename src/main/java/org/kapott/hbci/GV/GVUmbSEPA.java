...
public class GVUmbSEPA extends AbstractSEPAGV {
    ...
    public GVUmbSEPA(HBCIHandler handler, String name) {
        ...
        /*
         * dummy constraints to allow an application to set these values. the overriden setLowlevelParam() stores these values in a special structure which is
         * later used to create the SEPA pain document.
         */
