...
public class SepaUtil {
     ...
     * 
     * @param isoDate
     *            optional. Das zu verwendende Datum. Wird es weggelassen, dann wird das aktuelle Datum (mit Uhrzeit) verwendet.
     ...
     *            der Kalender.
     * @param format
     *            das zu verwendende Format. Fuer Beispiele siehe {@link SepaUtil#DATE_FORMAT} {@link SepaUtil#DATETIME_FORMAT} Wenn keines angegeben ist, wird
     *            per Default {@link SepaUtil#DATE_FORMAT} verwendet.
     ...
     * 
     * @param properties
     *            die Properties, mit denen gearbeitet werden soll
    ...
    /**
     * Liefert die Summe der Beträge aller Transaktionen. Bei einer Einzeltransaktion wird der Betrag zurückgeliefert. Mehrfachtransaktionen müssen die gleiche
     * Währung verwenden, da eine Summenbildung sonst nicht möglich ist.
     * 
     * @param sepaParams
     *            die Properties, mit denen gearbeitet werden soll
     * @param max
     *            Maximaler Index, oder {@code null} für Einzeltransaktionen
     ...
     * 
     * @param key
     *            Key, der mit einem Index ergaenzt werden soll
     * @param index
     *            Index oder {@code null}, wenn kein Index gesetzt werden soll
