            ...
            try {
                ...
                if (st.substring(st.indexOf("//") + 2).equals("Y")) {
                    ...
                    while (true) {
                        ...
                        pos1 = 12;
                        if (st.charAt(pos1) == 'N')
                            gattung.saldo = new BigDecimalValue("-" + st.substring(pos1 + 1).replace(',', '.'), curr);
                        else
                            gattung.saldo = new BigDecimalValue(st.substring(pos1).replace(',', '.'), curr);
                        ...
                        while (true) {
                            ...
                            pos1 = 17;
                            if (st.charAt(pos1) == 'N')
                                subsaldo.saldo = new BigDecimalValue("-" + st.substring(pos1 + 1).replace(',', '.'), curr);
                            else
                                subsaldo.saldo = new BigDecimalValue(st.substring(pos1).replace(',', '.'), curr);
