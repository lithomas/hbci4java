...
public final class GVInfoOrder extends HBCIJobImpl {
    ...
    public GVInfoOrder(HBCIHandler handler) {
        ...
        for (int i = 1; i < 10; i++) {
            addConstraint(HBCIUtilsInternal.withCounter("code", i), HBCIUtilsInternal.withCounter("InfoCodes.code", i), "", LogFilter.FILTER_NONE);
        }
    }
