...
public class GVSaldoReqSEPA extends GVSaldoReq {
    ...
    public GVSaldoReqSEPA(HBCIHandler handler) {
        ...
        /*
         * addConstraint("my.country","KTV.KIK.country","", LogFilter.FILTER_NONE); addConstraint("my.blz","KTV.KIK.blz","", LogFilter.FILTER_MOST);
         * addConstraint("my.number","KTV.number","", LogFilter.FILTER_IDS); addConstraint("my.subnumber","KTV.subnumber","", LogFilter.FILTER_MOST);
         */
