...
public final class HBCIInstitute implements IHandlerData {
    ...
    void extractKeys(Properties result) {
        ...
        try {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                HBCIUtils.log("found key " + keyCountry + "_" + keyBLZ + "_" + keyUserId + "_" + keyType + "_" + keyNum + "_" + keyVersion, HBCIUtils.LOG_INFO);
            ...
            if (!HBCIUtilsInternal.ignoreError(null, "client.errors.ignoreExtractKeysErrors", msg + ": " + HBCIUtils.exception2String(e))) {
    ...
    private void acknowledgeNewKeys() {
        ...
        HBCIUtilsInternal.getCallback().callback(passport, HBCICallback.NEED_NEW_INST_KEYS_ACK, HBCIUtilsInternal.getLocMsg("CALLB_NEW_INST_KEYS"),
                        HBCICallback.TYPE_BOOLEAN, answer);
        ...
        if (version.equals("0") || isBPDExpired() || hbciVersionOfBPD == null || !hbciVersionOfBPD.equals(kernel.getHBCIVersion())) {
            ...
            try {
                ...
                while (true) {
                    ...
                    status = kernel.rawDoIt(HBCIKernelImpl.DONT_SIGNIT, HBCIKernelImpl.DONT_CRYPTIT, HBCIKernelImpl.DONT_NEED_SIG,
