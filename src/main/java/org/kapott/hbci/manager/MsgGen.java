...
public final class MsgGen {
    ...
    /*
     * Initialisieren eines Message-Generators. Der <syntaFileStream> ist ein Stream, mit dem eine XML-Datei mit einer HBCI-Syntaxspezifikation eingelesen wird
     */
     ...
     * 
     *        The syntax description for the message to be generated is taken from an XML node @c MSGdef where the attribute @c id equals @p msgName.
     * 
     *        To build the message the values stored in @c clientValues will be used.
     * @param msgName
     *            The name (i.e. XML-identifier for a MSGdef-node) of the message to be generated.
     ...
     * @param path
     *            The path to the syntax element for which the value is to be set. For more information about paths, see SyntaxElement::SyntaxElement()
     * @param value
    ...
    /*
     * gibt für einen hbci-gv ("saldo3") die liste aller ll-job-parameter zurück
     */
    ...
    /*
     * gibt für einen hbci-gv ("saldo3") die liste aller ll-job-result-parameter zurück
     */
    ...
    /*
     * gibt für einen hbci-gv ("saldo3") die liste aller ll-job-restriction- parameter zurück
     */
