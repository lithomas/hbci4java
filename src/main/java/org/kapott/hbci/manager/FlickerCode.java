...
/**
 * Implementierung des Flicker-Codes fuer optisches ChipTAN. Basiert auf der Javascript-Implementierung von http://6xq.net/media/00/20/flickercode.html
 * 
...
public class FlickerCode {
    ...
    /**
     * Die Anzahl der Bytes, in der die Laenge des Challenge bei HHD 1.4 steht. Bei HHD 1.3 war das noch 2 Zeichen lang. Wenn der Flicker-Code nicht in
     * "Challenge HHDuc" uebertragen wurde sondern direkt im Freitext-Challenge, koennen wir das Problem umgehen, indem wir in clean() einfach eine "0" vorn
     * anhaengen. Wenn er aber tatsaechlich im "Challenge HHDuc" steht, kann man dem Code nicht ansehen, ob es ein HHD 1.3-Code ist. In dem Fall hilft nur
     * Try&Error. Also mit HHD 1.4 parsen. Und wenn das fehlschlaegt, dann HHD 1.3 versuchen.
     */
    ...
    /**
     * Entfernt das CHLGUC0026....CHLGTEXT aus dem Code, falls vorhanden. Das sind HHD 1.3-Codes, die nicht im "Challenge HHDuc" uebertragen wurden sondern
     * direkt im Challenge-Freitext,
     * 
     * @param code
     * @return
     */
    ...
    public class DE {
        ...
        /**
         * Die Laengen-Angabe des DE im Roh-Format. Sie kann noch Control-Bits enthalten, sollte daher also NICHT fuer Laengenberechnungen verwendet werden. In
         * dem Fall stattdessen <code>length</code> verwenden.
         */
        public int lde = 0;
         ...
         * 
         * @param s
         *            der String, dessen Anfang das DE enthaelt.
         ...
         * 
         * @return die codierten Nutzdaten. Wenn das DE keine Nutzdaten enthaelt, wird "" zurueck gegeben.
         */
        String renderLength() {
        ...
        /**
         * Liefert das zu verwendende Encoding fuer die Uebertragung via Flickercode. Im Normalfall (also nach dem Parsen eines HHDuc) ist kein Encoding
         * angegeben (im Challenge HHDuc ist das per Definition nie gesetzt) machen wir ASC. Es sei denn, das Encoding wurde explizit auf BCD gesetzt.
         * 
    ...
    /**
     * Bean fuer die Eigenschaften des Startcodes. Selbstverstaendlich sind hier so einige Sachen anders codiert als im DE. Waer ja auch zu einfach sonst. Die
     * Laengen-Angabe ist anders codiert (hex statt dec). Und nach der Laenge kommen nicht sofort die Nutzdaten sondern erst noch die Control-Bytes.
     */
    public class Startcode extends DE {
        ...
        /**
         * @see org.kapott.hbci.manager.FlickerCode.DE#renderLength() Ueberschrieben, weil wir hier noch reincodieren muessen, ob ein Controlbyte folgt.
         */
        String renderLength() {
    ...
    /**
     * Wandelt alle Zeichen des String gemaess des jeweiligen ASCII-Wertes in HEX-Codierung um. Beispiel: Das Zeichen "0" hat den ASCII-Wert "30" in
     ...
     * 
     * @param n
     *            die Zahl, deren Quersumme errechnet werden soll.
    ...
    /**
     * Liefert die Summe der Bit-Wertigkeiten fuer die genannten Bits (beginndend bei 0 und beim kleinsten Bit, angegebens inclusive).
     * 
     * Beispiel: num = 156 (-> 10011100) bits = 5
     * 
     * Es wird die Summe der Bitwertigkeiten 2^0 bis 2^5 errechnet. Also der Wert von **011100 = 2^4+2^3+s^2 = 28
     * 
     * @param num
     *            Zahl, aus der die Summe berechnet werden soll.
     * @param bits
     *            Anzahl der Bits (beginnend bei 0 und beim kleinsten Bit, angegebenes inclusive), deren Wertigkeit addiert werden soll.
     ...
     * @param bit
     *            die Nummer des zu pruefenden Bits. Wobei "0" das kleinste (rechts) und "7" das groesste (links) Bit ist.
...
/**********************************************************************
 * $Log: FlickerCode.java,v $ Revision 1.9 2011/06/24 16:53:23 willuhn
 * 
 ...
 *
 *    Revision 1.4 2011-05-27 11:21:38 willuhn *** empty log message ***
 *
 *    Revision 1.3 2011-05-27 11:20:36 willuhn *** empty log message ***
 *
 *    Revision 1.2 2011-05-27 11:19:44 willuhn *** empty log message ***
 *
