...
public class ObjectFactory {
    ...
    public String toString() {
        ...
        /*
         * for (Iterator i=usedObjects.iterator();i.hasNext();) { ret.append(System.getProperty("line.separator"));
         * 
         * Object o=i.next(); if (o instanceof SyntaxElement) ret.append("used: "+((SyntaxElement)o).toString(0)); else if (o instanceof MultipleSyntaxElements)
         * ret.append("used: "+((MultipleSyntaxElements)o).toString(0)); else ret.append("used: "+o.toString()); }
         */
