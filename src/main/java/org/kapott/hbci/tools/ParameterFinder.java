...
public class ParameterFinder {
     ...
     * 
     * @param props
     *            die Properties, in denen gesucht werden soll.
     * @param path
     *            der Pfad. Es koennen Wildcards verwendet werden. Etwa so: Params_*.TAN2StepPar*.ParTAN2Step*.TAN2StepParams*.*secfunc")
     * @return Liefert die gefundenen Properties. Als Schluessel wird jeweils nicht der gesamte Pfad verwendet sondern nur der Teil hinter dem letzten Punkt.
     */
...
/**********************************************************************
 * $Log: ParameterFinder.java,v $ Revision 1.1 2011/05/13 15:22:08 willuhn
 * 
