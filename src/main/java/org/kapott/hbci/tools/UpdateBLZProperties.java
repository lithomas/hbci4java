...
/**
 * Util-Klasse, welche die FinTS-Bankenliste im CSV-Format (kann von http://www.hbci-zka.de/institute/institut_hersteller.htm bezogen werden) parst, un die
 * aktualisierten Daten in die blz.properties von HBCI4Java uebernimmt.
 */
public class UpdateBLZProperties {
    ...
    /**
     * @param args
     *            1. Pfad/Dateiname zu "fints_institute.csv". 2. Pfad/Dateiname zu "blz.properties". 3. Pfad/Dateiname zur neuen "blz.properties".
     * @throws Exception
     */
