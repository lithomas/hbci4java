 ...
 * werden. Der Sinn dieser Klasse ist die Zusammenfassung von mehreren Status-Informationen, die logisch zusammengehören (z.B. alle Status-Informationen, die
 * ein bestimmtes Nachrichtensegment betreffen).
 * </p>
 * <p>
 * Objekte dieser Klasse werden beispielsweise in {@link org.kapott.hbci.status.HBCIMsgStatus} verwendet, um globale und segmentbezogene Status-Informationen
 * voneinander getrennt zu sammeln.
 * </p>
 */
public final class HBCIStatus {
     ...
     * 
     * @return <code>true</code>, falls Exceptions gespeichert sind, sonst <code>false</code>
     */
     ...
     * 
     * @return <code>true</code>, falls Fehlermeldungen vorhanden sind, sonst <code>false</code>
     */
     ...
     * 
     * @return <code>true</code>, falls Warnungen vorhanden sind, sonst <code>false</code>
     */
     ...
     * 
     * @return <code>true</code>, falls Erfolgsmeldungen vorhanden sind, sonst <code>false</code>
     */
     ...
     * 
     * @return Array mit Exceptions, die während der HBCI-Kommunikation aufgetreten sind.
     */
     ...
     * 
     * @return Array mit <code>HBCIRetVal</code>s, die während der HBCI-Kommunikation aufgetreten sind.
     */
    ...
    /**
     * Gibt einen Code zurück, der den zusammengefassten Status aller in diesem Objekt gespeicherten Rückgabewerte beschreibt. Dafür gibt es folgende
     * Möglichkeiten:
     * <ul>
     * <li><code>STATUS_OK</code> wird zurückgegeben, wenn es keine Fehlermeldungen oder Exceptions gegeben hat und mindestens eine Erfolgsmeldung oder Warnung
     * enthalten ist</li>
     * <li><code>STATUS_ERR</code> wird zurückgegeben, wenn wenigstens eine Exception aufgetreten ist oder wenigstens eine Fehlermeldung enthalten ist.</li>
     * <li><code>STATUS_UNKNOWN</code> wird zurückgegeben, wenn keine der beiden o.g. Bedingungen zutrifft.</li>
     * </ul>
     * 
     * @return einen Code, der den zusammengefassten Status aller Rückgabewerte beschreibt.
     */
    public int getStatusCode() {
        int code;

        /*
         * TODO: eine Exception als Fehler einzustufen ist gefaehrlich: wenn ein GV bei einer Bank eingereicht wird und von der Bank erfolgreich verarbeitet
         * wird, beim Entgegennehmen der Antwort-Nachricht jedoch eine Exception auftritt, sieht der Job aus wie "fehlgeschlagen" - dabei ist nur das Parsen der
         * Erfolgsnachricht fehlgeschlagen
         */
    ...
    /**
     * Gibt <code>true</code> zurück, wenn keine Fehlermeldungen bzw. Exceptions aufgetreten sind und wenigstens eine Successmeldung oder Warnung enthalten ist
     */
    public boolean isOK() {
    ...
    /**
     * Gibt einen String zurück, der alle Fehlermeldungen der hier enthaltenen Rückgabewerte im Klartext enthält. Für evtl. enthaltene Exception wird die
     * entsprechende Beschreibung in Kurz (siehe {@link org.kapott.hbci.manager.HBCIUtils#exception2StringShort(Exception)}) benutzt.
     * 
