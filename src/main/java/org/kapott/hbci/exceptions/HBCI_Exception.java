...
/**
 * Diese Klasse ist die Super-Klasse aller Exceptions, die durch den HBCI-Kernel erzeugt werden. Beim Auftreten einer solchen Exception sollten die Messages der
 * gesamten(!) Exception-Kette angezeigt werden, um die Fehlerursache bestmöglich bestimmen zu können.
 * 
 * <pre>
 * try {
...
public class HBCI_Exception extends RuntimeException {
     ...
     * 
     * @param s
     *            Message, die bei <code>getMessage()</code> zurückgegeben werden soll
     */
     ...
     * 
     * @param e
     *            "Ursache" dieser Exception, die in der Exception-Kette als <code>getCause()</code> zurückgegeben werden soll
     */
